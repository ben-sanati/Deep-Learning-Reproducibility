...
class gdtuoSGDPerParam(Optimizable):
    '''
...
class gdtuoAdaGrad(Optimizable):
    '''
...
class gdtuoRMSProp(Optimizable):
    '''
    ...
    def step(self, params):
        self.optimizer.step(self.parameters)
        gamma = gdtuoRMSProp.clamp(self.parameters['gamma'])
...
class gdtuoRMSPropAlpha(Optimizable):
    '''
...
class gdtuoAdamBaydin(Optimizable):
